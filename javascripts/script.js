$(document).ready(function() {
          ...
          //key
          /*
            var keycabin = key.rect(0, 0, 30, 30).attr(cabin).data('id', 'key-cabin');
            //key.text(70,15, "Cabins").attr({'font-size': '22px'});
            var keyrv = key.rect(0, 40, 30, 30).attr(rv).data('id', 'key-rv');
            var keyseasonal = key.rect(0, 80, 30, 30).attr(seasonal).data('id', 'key-seasonal');
            var keytent = key.rect(0, 120, 30, 30).attr(tent).data('id', 'key-tent');
            var keybeach = key.rect(0, 160, 30, 30).attr({fill: colors['beach'],id: 'key-beach','stroke-width': '0','stroke-opacity': '0'}).data('id', 'key-beach');
          */
