$(document).ready(function() {
          ...
          //rv sites
            sites.rv1 = rsr.path("M748.5,823.834 715.062,794.312 730,777.562 767.167,803.834  z").attr({fill: '#68923D', id: 'rv1','stroke-width': '0','stroke-opacity': '0'}).data('id', 'rv1').data('class', 'rv');
            ...
            sites.rv8 = rsr.path("M767.166,573.41 c -4.354,-8.794 -8.813,-17.802 -13.332,-26.928 l -36.04,19.658 c 4.253,9.149 8.423,18.125 12.459,26.812 l 36.913,-19.542 z").attr({id: 'rv8',fill: '#68923d','stroke-width': '0','stroke-opacity': '0'}).data('id', 'rv8').data('class', 'rv');
