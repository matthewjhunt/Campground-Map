$(document).ready(function() {
          ...
          siteNumbers.rv1 = rsr.text(740,801, "1").attr(siteNumberStyle);
          ...
          siteNumbers.rv2 = rsr.text(773,765, "2").attr(siteNumberStyle);
          sites.rv3 = rsr.path("M807.977,655.641l-40.138,17.66c1.457,3.127,2.81,6.028,4.042,8.668c4.723,10.117,6.36,12.72,7.56,18.84  c11.521-0.96,50.761-0.24,50.761-0.24S821.536,683.048,807.977,655.641z").attr(seasonal).data('id', 'rv3').data('class', 'seasonal');
          sites.rv5 = rsr.path("M792.119,623.872l-38.123,20.039c4.954,10.66,9.383,20.184,13.107,28.181l40.137-17.66  C802.703,645.26,797.612,634.972,792.119,623.872z").attr({fill: '#68923D',id: 'rv5','stroke-width': '0','stroke-opacity': '0'}).data('id', 'rv5').data('class', 'rv');
          sites.rv6 = rsr.path("M779.866,599.151l-37.821,19.144c4.028,8.671,7.852,16.901,11.398,24.536l38.124-20.039  C787.841,615.263,783.924,607.348,779.866,599.151z").attr({fill: '#68923D',id: 'rv6','stroke-width': '0','stroke-opacity': '0'}).data('id', 'rv6').data('class', 'rv');
          ...
          for (var site in sites) {
                ...
                (function (st, site) {
                    ...
                    $(st[0], siteNumbers[0]).mouseover(function() {
                        //original color gets messed up if it's fading out and they go over it again, try to target the original style instead
